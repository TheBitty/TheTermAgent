...
class OllamaHelper:
    ...
    def _make_request(
        self, endpoint: str, method: str = "GET", json_data: dict = None, timeout: int = 10
    ) -> requests.Response:
        """
        ...
        """
        response = requests.request(method, f"{self.base_url}/api/{endpoint}", json=json_data, timeout=timeout)
