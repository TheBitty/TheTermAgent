...
from ui_utils import UIUtils, print_banner, show_help, LoadingIndicator
            ...
            try:
                ...
                if cmd_result and hasattr(cmd_result, 'returncode') and cmd_result.returncode != 0:
                    ...
                    if config.get('ai.help_on_error', True) and ollama.is_available():
                        ...
                        try:
                            error_help = ollama.get_error_help(user_input, cmd_result.stderr if hasattr(cmd_result, 'stderr') else "")
